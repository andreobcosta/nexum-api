...
| Commit estável | dea5b97 / Sprint 1 completa em produção |
...
- `motor_config`, `feedback_queue`, `feedbacks`, `system_prompts`, `system_prompts_history`, `report_layout`, `instrument_library`
...
- [ ] D1 ✓: Revisor valida contra instrument_library (13 validações clínicas)
- [ ] D2 ✓: score mínimo de 20 → **40** (somente após D1 implementado)
- [ ] D3 ✓: getSystemPrompt() async com Firestore + fallback arquivo
...
- Score mínimo **nunca remover** — apenas aumentar (atual 20, deve ir para 40 após D1)
