...
const LAYOUT_FIELDS = ['fonte', 'tamanho', 'cores', 'cabecalho', 'logo_url'];
...
router.get('/layout', async (req, res) => {
  try {
    ...
    res.json(doc.exists ? doc.data() : { fonte: null, tamanho: null, cores: null, cabecalho: null, logo_url: null });
  } catch (err) {
